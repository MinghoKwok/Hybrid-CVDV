...
class CVCouplingMap:
    ...
    def draw(self):
        """Draws the coupling map with node attributes for qubits and qumodes."""
        ...
        # Add edges to the graph (handling the case with no edge data)
        for src, dst in self.graph.edge_list():
